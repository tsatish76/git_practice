...
export const buildStockReturnsMatrix = (
  ...
  return holdingStocks.map(stock => {
    ...
    const xirrTx = buildPerStockXIRRTransactions(stockOrders, currentValue);
...
// ============================================================================
export const buildPerStockXIRRTransactions = (stockOrders, currentValue) => {
  ...
  const asOf = stockOrders[stockOrders.length - 1]?.date;
